...
namespace Linca_David_Lab2_MasterEB.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Linca_David_Lab2_MasterEBContext context)
        {
            _context = context;
        }
        ...
        {
            var linca_David_Lab2_MasterEBContext = _context.Order.Include(o => o.Book).Include(o => o.Customer);
            return View(await linca_David_Lab2_MasterEBContext.ToListAsync());
        }
